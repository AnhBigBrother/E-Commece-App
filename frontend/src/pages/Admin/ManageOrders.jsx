  ...
  return (
    <div
      ...
      <div className='text-nowrap flex flex-col'>
        ...
        <p className='text-sm italic font-light'>User: {order.user}</p>
        <p className='text-sm italic font-light'>Phone number: {order.phonenumber}</p>
        <p className='text-sm italic font-light'>Shipping address: {order.shippingAddress}</p>
...
const ManageOrders = () => {
  const [isLoading, data, setData] = useFetch('/admin/orders');
